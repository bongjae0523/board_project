                                ...
                                <div class="p-5">
                                    <div class="text-center">
	                                    ...
	                                    <c:choose>                                                                          
								            ...
								            <c:otherwise>                                                                     
								                <p class="mb-4">${searchVO.userid}</p>                                              
								            </c:otherwise>                                                                    
								        </c:choose>  
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="${pageContext.request.contextPath}/member/search_id">아이디 찾기!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="${pageContext.request.contextPath}/member/search_pwd">비밀번호 찾기!</a>
                                    </div>
                                    <div class="text-center">
